...
from graphviz.lang import KEYWORDS

from compiler.error import IllegalCharError, ExpectedCharError
...
class Lexer:
    ...
    def make_tokens(self):
        ...
        # Lets the parser know that the end of file has been reached
        token_list.append(Token(TT_EOF, pos_start=self.pos))
